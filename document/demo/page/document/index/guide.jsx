...
const HelloWorld = () => {
    return (
        <div className={classes.paddingRightAndBottom}>
            ...
            <div
                className={classes.explaination}
                dangerouslySetInnerHTML={string3_1}
            />
            <pre className={classes.codeBox}>
                <code
                    className="javascript hljs"
            ...
            <div
                className={classes.explaination}
                dangerouslySetInnerHTML={string3_2}
            />
            <pre className={classes.codeBox}>
                <code
                    className="javascript hljs"
            ...
            <div
                className={classes.explaination}
                dangerouslySetInnerHTML={string4}
            />
            <pre className={classes.codeBox}>
                <code
                    className="javascript hljs"
            ...
            <div
                className={classes.explaination}
                dangerouslySetInnerHTML={string5}
            />
            <pre className={classes.codeBox}>
                <code
                    className="javascript hljs"
            ...
            <div
                className={classes.explaination}
                dangerouslySetInnerHTML={string6}
            />
            <pre className={classes.codeBox}>
                <code
                    className="javascript hljs"
            ...
            <div
                className={classes.explaination}
                dangerouslySetInnerHTML={string7}
            />
        </div>
    );
};
